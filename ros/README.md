...
| `depth_fusion` | `map_source` | choice: file, volume | file | yes | where /map comes from: the saved file another node serves, or the volume's own lidar layer published from here at map_hz |
