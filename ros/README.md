...
- **`map_grow`** — number 0..1, default 0.15
  ...
  - *Off when:* lower it to let the mask see smaller changes — a chair moved 10 cm is news at 0.05 and the map at 0.15; 0 explains only the occupied cell itself
