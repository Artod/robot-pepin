...
class RtabmapFrame(Node):
    ...
    def _report(self) -> None:
        ...
        graphs are pending a sharp one, the last word's gap to the tracker, what the graph's word
        is worth and why (:class:`pepin.graphtrust.GraphReport`: the trust, the metres since the
        graph last tied the present to an older node, the highest hypothesis) and the switches."""
        anchor = (
        ...
        trust = self._trust.report(self._origin == "file")
        self.get_logger().info(
