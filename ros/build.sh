...
rsync -a --delete --exclude '__pycache__' --exclude 'pepin_src' --exclude 'maps/rec' --exclude 'logs' --exclude 'maps/*.places.yaml' --exclude 'maps/last_pose.json' --exclude 'maps/*.db*' --exclude 'maps/*.npz*' "$HERE/" "root@$BOARD:/root/pepin-ros/"
